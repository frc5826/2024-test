...
public class TeleopDriveCommand extends Command {
    ...
    private final PID turnPID = new PID(4, 0, 0, maxAngularVelocity, 0.5, 0.03, this::getTurnDiff);
    ...
    public void execute() {
        ...
        rx = Math.abs(rx) > teleDriveDeadband ? rx : 0;
        ry = Math.abs(ry) > teleDriveDeadband ? ry : 0;
